<template>
  ...
  <el-scrollbar style="width: 100%;">
    <SnapshotExhibitCard style="margin-bottom: 10px;"
      :snap='snap'
      :index='index'
...
import SnapshotExhibitCard from './SnapshotExhibitCard.vue';

/**
 * 需要得知对当前左侧命令的版本号  如果一致，那么直接进行还原，不一致择需要打开新页面  加载对应版本的命令
 */
export default {
  name: 'snapshot-exhibit-list',
  components: { SnapshotExhibitCard },
  data() {
    return {
      paramVal: [],
      optionVal: [],
